...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/c61z1qnVz9)
...
```sh
npx nx serve meal-panner2
```

To create a production bundle:

```sh
npx nx build meal-panner2
```

To see all available targets to run for a project, run:

```sh
npx nx show project meal-panner2
```
